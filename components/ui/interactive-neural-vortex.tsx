...
export function InteractiveNeuralVortex() {
  ...
  useEffect(() => {
    ...
    const gl =
      canvasEl.getContext("webgl") || (canvasEl as any).getContext("experimental-webgl");
    if (!gl) {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Premium Blue/Purple Neural Colors
    ...
    const compileShader = (gl: any, source: string, type: number) => {
